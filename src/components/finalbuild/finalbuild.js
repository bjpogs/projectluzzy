...
const Finalbuild = () => {
    ...
    useEffect(() => {
        if (localStorage.getItem('isAuthenticated')){
            ...
            alert('You need to login first before build a cake.')
    ...
    // checkouy
    const checkout = () => {
        if (!document.getElementById('date').value) return alert('please select reservation date.')
        ...
        <div class="page landing-page">
            <section class="">
                <div class="row mx-0 my-0 px-0 py-0 align-items-center">
                    ...
                    <div class="d-block d-md-none col-sm-12 col-md-6 mx-0 my-0 px-0 py-0">
                        <section class="leftbuildcard">
                            { !layer?<div class="cakebase3">
