...
const [minDate, setMinDate] = useState(() => {
    ...
    const handleSubmit = (e) => {
        ...
        form.append('first_name', formd.first_name  ? formd.first_name: document.getElementById('FirstName').value)
        form.append('last_name', formd.last_name  ? formd.last_name : document.getElementById('LastName').value)
        form.append('address', formd.add_house  ? formd.add_house + ' ' + formd.add_brgy + ', ' + formd.add_city + ', ' + formd.add_province : document.getElementById('Address').value)
        form.append('contact_number', formd.contact_no ? formd.contact_no : document.getElementById('ContactNumber').value)
        form.append('email', formd.email_address ? formd.email_address : document.getElementById('email').value)
    ...
    function SuccessModal(props) {
        return (
          ...
          >
            ...
            <Modal.Body>
                <h4>Order number : <b>{data.order_id}</b></h4>
                ...
                <span>Special Request : <b>{data.specialrequest != "" ? data.specialrequest : 'None'}</b></span>
            </Modal.Body>
            <Modal.Footer>
